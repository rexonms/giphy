const getActions = (actionName, userResponse) => {
  ...
  const actions = {
    ...
    indexContent: {
      type: 'add',
      path: `${destination}/${path}/${name}/${name}Content.js`,
      templateFile: `${templateRoot}/${template}/ConnectedComponentContent.hbs`,
    },
    ducks: {
      type: 'add',
      path: `${destination}/${path}/${name}/ducks/index.js`,
      templateFile: `${templateRoot}/${template}/ducks/index.hbs`,
    },
    story: {
      type: 'add',
